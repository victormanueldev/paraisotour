...
var app = new Vue({
    ...
    methods: {
        ...
        md5Encryption(){
            ...
            console.log(this.paymentForm.apiKey, this.paymentForm.merchantId,this.paymentForm.referenceCode, this.paymentForm.totalPayment, this.paymentForm.currency);
            console.log(this.paymentForm.signature);
        },
        submitForm(){
