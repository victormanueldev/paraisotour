...
<body>
	...
	<p style="display: none" class="text-bottom" >
		...
		<div id="headermb" class="desktop-hide  navbarmb">
				...
				<div class="search" style="z-index: 15;height: 43px ;position: absolute;top: 20%;left: 10px;width: 77%;">
...
height: 500px;">
			...
			<div class="slider fullscreen">
				<div class="menu-container">
					<div class="exp-sin-lim">

						<span class="spantxt"> Experiencias</span><br>
						<span class="spantxt1">sin</span><span class="spantxt2"> limites!</span>
							...
							<div class="menu">
								...
								<div class="center-search-items">
									...
									<div class="search" style="z-index: 15;">
										<input  id="idsearch2" type="text" class="search-input" placeholder="  Destino,pasadía, excursión"  v-model="searchInput">
										<button type="submit" class="search-button">
											<i class="material-icons" style="position: absolute;left: 4px;top: 1px;">search</i>
										</button>
